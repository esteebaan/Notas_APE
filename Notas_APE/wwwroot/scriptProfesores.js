...
async function cargarEstudiantes() {
    ...
    try {
        ...
        const response = await fetch('https://localhost:7205/api/Estudiantes');
...
async function cargarNotas() {
    ...
    try {
        ...
        const response = await fetch('https://localhost:7205/api/Notas');
...
async function cargarPromedios() {
    ...
    try {
        ...
        const response = await fetch('https://localhost:7205/api/Promedios');
...
async function cargarNotaParaEditar(notaId) {
    ...
    try {
        ...
        const response = await fetch(`https://localhost:7205/api/Notas/${notaId}`);
...
document.getElementById('form-nueva-nota').addEventListener('submit', async function (e) {
    ...
    try {
        ...
        let url = 'https://localhost:7205/api/Notas';
...
async function cargarCursos() {
    ...
    try {
        ...
        const response = await fetch('https://localhost:7205/api/Cursos');
...
document.getElementById('cedulaInput').addEventListener('input', function () {
    ...
    debounceTimer = setTimeout(async () => {
        ...
        if (/^\d{5,10}$/.test(input)) {
            ...
            url = `https://localhost:7205/api/Estudiantes/filtrar?cedula=${input}`;

        } else {

            url = `https://localhost:7205/api/Estudiantes/filtrar?apellido=${input}`;
